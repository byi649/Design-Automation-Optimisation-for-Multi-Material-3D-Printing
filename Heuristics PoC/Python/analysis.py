...
if __name__ == '__main__': 
    ...
    for i in range(niter):
        ...
        GA_first[1] += np.argmax(GA_runs[i]<0.1) if np.argmax(GA_runs[i]<0.1) > 0 else 250
        CMA_first[1] += np.argmax(CMA_runs[i]<0.1) if np.argmax(CMA_runs[i]<0.1) > 0 else 250
        GA_1_first[1] += np.argmax(GA_1_runs[i]<0.1) if np.argmax(GA_1_runs[i]<0.1) > 0 else 250
        GA_first[2] += np.argmax(GA_runs[i]<0.01) if np.argmax(GA_runs[i]<0.01) > 0 else 250
        CMA_first[2] += np.argmax(CMA_runs[i]<0.01) if np.argmax(CMA_runs[i]<0.01) > 0 else 250
        GA_1_first[2] += np.argmax(GA_1_runs[i]<0.01) if np.argmax(GA_1_runs[i]<0.01) > 0 else 250
