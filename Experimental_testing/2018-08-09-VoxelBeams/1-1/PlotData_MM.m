...
xlabel('Frequency [Hz]')
ylabel('SPL [dB]')
title('Voxel Beam Solution 1-1 - In-Plane Excitation')
...
xlabel('Frequency [Hz]')
ylabel('SPL [dB]')
title('Voxel Beam Solution 1-1 - Out-of-Plane Excitation')
...
xlabel('Frequency [Hz]')
ylabel('SPL [dB]')
title('Voxel Beam Solution 1-1 - Torsional Excitation')
